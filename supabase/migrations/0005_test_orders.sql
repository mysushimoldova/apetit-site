...
--
-- Здесь пометка ставилась отдельным UPDATE сразу после вставки. С
-- миграции 0006 её ставит сама place_order(), той же вставкой — этот
-- файл заводит только колонку и индекс.
