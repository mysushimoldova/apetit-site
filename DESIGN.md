...
**Версия:** 2.4 · 21.09.2026 · утверждено по макетам docs/mock-*.png · собрана по референсам Амяна (см. ниже) + бренд Apetit из PSD меню
...
Фон — Cream (#FAF7F2) + слой контурных линий (как на меню-экранах в точках).
...
| `scale` | 900 | масштаб рисунка (px на клетку узора) |
