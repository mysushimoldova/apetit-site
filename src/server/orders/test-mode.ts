// Признак «этот заказ оставлен прогоном тестов» (orders.is_test: колонка —
// миграция 0005, параметр place_order() — 0006). База у разработки и у боевого сайта одна, поэтому тестовость
